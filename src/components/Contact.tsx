    ...
    <div className="container px-6 py-12 mx-auto">
        ...
        <div className="grid grid-cols-1 gap-12 mt-10 lg:grid-cols-3 sm:grid-cols-2 ">
            <div className="p-4 rounded-lg bg-blue-50 md:p-6">
                ...
                <p className="mt-2 text-sm text-gray-500">My personal email.</p>
            ...
            <div className="p-4 rounded-lg bg-blue-50 md:p-6">
                ...
                <p className="mt-2 text-sm text-gray-500">Discover my projects!</p>
            ...
            <div className="p-4 rounded-lg bg-blue-50 md:p-6">
                ...
                <p className="mt-2 text-sm text-gray-500">Mon-Fri from 8am to 6pm.</p>
